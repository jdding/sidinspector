...
\begin{table}[t]
\caption{Same-item Musical artifact profiles. This is not a downstream
leaderboard; GRID feature-text uses ReSID processed feature text rather than a
faithful raw-text TIGER reproduction, and ReSID is a bounded GAOQ export.}
\label{tab:musical-diagnostic}
\small
\setlength{\tabcolsep}{2.2pt}
\begin{tabular}{@{}lrrrrr@{}}
\toprule
System & Items & Unique & D2 coll. & D3 L1 & D4 tail \\
\midrule
GRID feature-text & 23,742 & 3,749 & 0.9769 & 0.0552 & 0.3695 \\
ReSID bounded & 23,742 & 23,742 & 0.0000 & 0.1535 & 1.0000 \\
\bottomrule
\end{tabular}
\end{table}
