...
\begin{table}[t]
\caption{Reviewer-facing artifact package. The package is organized around
re-running audits and inspecting provenance rather than reproducing all
...
Component & Purpose \\
\midrule
Adapter API & Normalize item-to-\sid mappings, metadata, interactions, and
optional generator outputs into one contract. \\
Metric runners & Compute D1--D5a tables and optional D6 churn from normalized
artifacts. \\
Generated tables & Provide CSV, Markdown, and \LaTeX{} outputs for the main
case study, sanity controls, scale checks, churn, and portability smoke. \\
Manifests & Separate public assets, ignored local caches, timestamps, and
method caveats. \\
Runbooks & Record local-first execution and AutoDL staging without requiring
reviewers to rerun GPU experiments. \\
\bottomrule
\end{tabularx}
\end{table}
