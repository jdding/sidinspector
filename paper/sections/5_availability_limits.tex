...
\begin{table}[t]
\caption{Reviewer-facing artifact contract. The table lists what a clean
checkout exposes; expensive metric rebuilds remain optional and are documented
through manifests.}
\label{tab:artifact-package}
\small
\setlength{\tabcolsep}{3pt}
\begin{tabular}{@{}p{0.20\columnwidth}p{0.38\columnwidth}p{0.32\columnwidth}@{}}
\toprule
