...
including a same-item Musical case study and method-inspired controllers for
collision qualification, capacity pressure, and variable-depth cost. The demo
is used to make diagnostic
findings, not model-quality claims: it separates full-code collision pressure,
collaborative-prefix recovery, tail capacity, and structural prefix fan-out
before a downstream generator is trained. The paper follows the CIKM Resource
four-page constraint, where appendices count toward the limit and detailed logs
are therefore placed in the online artifact~\cite{cikm2026resource}.
