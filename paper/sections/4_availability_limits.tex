...
quickstart. The anonymous review artifact is available at
\url{https://anonymous.4open.science/r/sidinspector-9BB2}, with a
clean-checkout verifier for the published tables and figure. Large local
artifacts are kept out of git and described through manifests so that reviewers
can distinguish public reproducibility assets from local caches.
