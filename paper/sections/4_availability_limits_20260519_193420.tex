...
interaction-qualified controller, but it is still not strict causal harm. D3 is
a diagnostic proxy and is not yet proven monotonic with Recall@K or NDCG. D5a
is a structural cost proxy without real generator-output latency, and D6
remains optional drift evidence.
