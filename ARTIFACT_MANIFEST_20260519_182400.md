...
| `docs/CONTROLLED_STRESSOR_SELECTION.md` | controlled-stressor/controller policy and method-coverage boundary | inspectable |
...
- `docs/CARD_ORIGINAL_NURQVAE_EVIDENCE_GATE.md`: failure report showing why
  ...
  public repo.
- `docs/CONTROLLED_STRESSOR_SELECTION.md`: policy for keeping synthetic or
  sanity controllers separate from named-method evidence.
