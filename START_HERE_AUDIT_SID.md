...
28. `docs/AUTODL_READINESS_REPORT.md`
...
2. use `docs/AUTODL_READY_HANDOFF.md`, `docs/AUTODL_READINESS_REPORT.md`, and `tools/autodl_audit_sid/run_remote_audit_sid.sh` once the fixed RTX 5090 instance is ready;
