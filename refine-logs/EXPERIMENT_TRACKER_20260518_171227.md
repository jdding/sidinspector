...
| A104 | D1-D5a metric implementation | TODO | TBD | Utilization, collision harm, semantic-collaborative alignment, head-tail capacity, lightweight SID-trie deployment-cost proxy. |
