...
| A138 | Full experiment-plan audit | CLOSED_FOR_V0 | `docs/EXPERIMENT_PLAN_FULL_AUDIT.md`, `docs/EXPERIMENT_PLAN_FULL_AUDIT_20260519_230854.md`, `docs/EXPERIMENT_PLAN_FULL_AUDIT.json` | Full plan-to-evidence audit confirms the CIKM Resource v0 experiment package is closed: required experiments are complete, explicitly negative-closed, or future-scoped. Remaining work is submission hygiene and final paper QA, not new local/GPU experiments. |
...
carry row/column structure rather than paragraph text. Table 1 is a coverage
matrix, Table 3 is a compact metric-signal table, and Table 4 is a reviewer
artifact checklist. Table 2 remains the main numeric case-study result table.
