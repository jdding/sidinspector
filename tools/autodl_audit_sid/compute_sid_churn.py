...
def compute_churn(old_sid: pd.DataFrame, new_sid: pd.DataFrame) -> pd.DataFrame:
    ...
    for dataset in group_values:
        ...
        for depth in range(1, max_depth + 1):
            ...
            old_prefix_cols = old_levels[:depth]
            new_prefix_cols = new_levels[:depth]
            rows.append(
                {
                    **key_values,
                    "prefix_depth": depth,
                    ...
                    **_collision_stats(old_group, old_prefix_cols, "old"),
                    **_collision_stats(new_group, new_prefix_cols, "new"),
                }
            )
