...
GAOQ_KMEANS_N_INIT="${GAOQ_KMEANS_N_INIT:-3}"
GAOQ_LEVEL2_PARALLEL_JOBS="${GAOQ_LEVEL2_PARALLEL_JOBS:-1}"
GAOQ_LEVEL2_PARALLEL_BACKEND="${GAOQ_LEVEL2_PARALLEL_BACKEND:-loky}"
