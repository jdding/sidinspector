...
|---|---|---|---|
| Table 1 | yes | Method coverage and artifact caveats | `paper_assets/tables/table1_method_coverage.*` |
| Table 2 | yes | GRID Musical feature-text vs ReSID Musical D1-D5a | `paper_assets/tables/table2_musical_diagnostic.*` |
...
submission with no required appendix; optional tables live in the GitHub
artifact.
