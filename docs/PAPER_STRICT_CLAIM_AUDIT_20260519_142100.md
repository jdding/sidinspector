...
Timestamp: 2026-05-19 14:21:00 CST
...
after the two internal review rounds.
...
| D2 limit | Section 2 and Section 4 say D2 is collision profile, not causal harm | ok |
...
1. The local ACM draft is still anonymous. If CIKM 2026 Resource submission is
   ...
   submission.
2. The artifact should be frozen through a stable branch or release tag before
   external simulated review and final submission.
...
while references and the GenAI Usage Disclosure extend onto page 5. Fig. 1 is a
generated vector PDF. Table 1 is a facet/status/boundary matrix, Table 2 is the
same-item Musical artifact-profile table with D5a prefix counts, and Table 3 is
a reviewer action checklist.
