...
| Citation audit | `docs/CITATION_AUDIT.md` | Verified primary links and citation use rules; final BibTeX still pending |
...
benchmark. Remaining gaps are final BibTeX generation, LaTeX fitting, and
