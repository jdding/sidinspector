...
| Table 1 | method coverage | Cluster, dataset, artifact status, diagnostics supported, caveat | `paper_assets/tables/table1_method_coverage.*` | high |
| Table 2 | diagnostic case study | GRID Musical feature-text row vs ReSID Musical D2/D3v2/D4/D5a compact table | `paper_assets/tables/table2_musical_diagnostic.*` | high |
