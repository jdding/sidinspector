...
| DIG | B/D | needs ranking-aligned tokenizer artifact | direct/proxy | proxy | direct | proxy | gen/proxy | NF | optional if artifact exists |
...
| AdaSID / CARD | B | needs adaptive/collision-aware mapping | direct | direct | proxy | direct | proxy | proxy | optional replacement for ReSID/CapsID |
...
| CapsID | B | variable/soft SID | TBD | TBD | TBD | TBD | TBD | optional/future | Strong if artifact available |
| DIG | B/D | ranking-aligned tokenizer | TBD | TBD | TBD | TBD | TBD | optional/future | Likely literature target unless code exists |
| AdaSID / CARD | B | collision/utilization design | TBD | TBD | TBD | TBD | TBD | optional/future | Strong if code available |
