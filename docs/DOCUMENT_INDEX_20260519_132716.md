...
| Figure/table strategy | `docs/PAPER_FIGURE_TABLE_STRATEGY.md` | One-figure/two-table PDF plan and artifact-repo table boundary |
...
| CIKM paper draft | `paper/main.tex` | ACM draft; `paper/main.pdf` currently compiles to 3 pages |
...
- `paper/main.pdf` compiles to 3 pages with Fig. 1, redesigned Table 1, and
  compact Table 2.
