...
- Paper-writing stance: the latest draft adds a compact controlled-stressor
  table and polishes the prose toward CIKM/SIGIR-style resource writing.
...
| CIKM paper draft | `paper/main.tex` | ACM draft; `paper/main.pdf` currently compiles to 5 pages total, with body through page 4 and controlled-stressor Table 3 in Section 3 |
