...
```text
_gate0_artifacts/autodl_bundle/audit_sid_autodl_20260518_193310.tar.gz
```
...
```text
e052e148b69169da888bee60a745bdee7a7242b8801c8548a1f16c12f60549c5
```
...
tar -xzf audit_sid_autodl_20260518_193310.tar.gz -C /root/autodl-tmp/Sec_phrase
...
If CARD source is still incomplete, the CARD entry is skipped and summarized as `SKIPPED_CARD_SOURCE_INCOMPLETE`.
