...
11. External simulated review has not yet been run; it should use CIKM 2026
    Resource Track as the fixed target and judge whether the draft remains at or
    above the internal 8/10 bar.
