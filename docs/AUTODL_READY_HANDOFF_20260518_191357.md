...
```text
_gate0_artifacts/autodl_bundle/audit_sid_autodl_20260518_191357.tar.gz
```
...
```text
dcc7d4bb8ae0b5985e58faaf536e49882f4967e94a4f549d06993bb6a1d69ba0
```
...
tar -xzf audit_sid_autodl_20260518_191357.tar.gz -C /root/autodl-tmp/Sec_phrase
