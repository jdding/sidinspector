...
Fig. 1 is a generated vector PDF. Table 1 is a facet-by-diagnostic coverage
matrix, Table 2 is the same-item Musical artifact-profile table with D5a prefix
counts and sanity/calibration rows, and Table 3 is the controlled-stressor
signal table. The older reviewer artifact checklist table has been deleted;
clean-checkout verification is summarized in Section 5.
