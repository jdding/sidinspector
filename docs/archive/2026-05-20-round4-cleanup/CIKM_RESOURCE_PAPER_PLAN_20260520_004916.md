...
Resource Track framing. To push toward a stronger-review range, prioritize
evidence breadth rather than adding more diagnostic dimensions.
...
- Table 3: controlled-stressor signal table.
...
| Table 3 | controlled stressors | Qualified collision, capacity budget, and variable-depth signals | `paper/sections/4_demonstration.tex`, `paper_assets/tables/table8_qualified_collision_probe.*`, `paper_assets/tables/table9_capacity_budget_sweep.*`, `paper_assets/tables/table10_variable_depth_cost_probe.*` | high |
