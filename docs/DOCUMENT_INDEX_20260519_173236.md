...
| CARD | original `nu-rq-vae` source/import/export-contract preflight passed; still not primary evidence | `docs/CARD_SOURCE_REPAIR.md`, `docs/THIRD_METHOD_EVIDENCE_GATE.md`, `tools/autodl_audit_sid/preflight_card_nurqvae.py` |
