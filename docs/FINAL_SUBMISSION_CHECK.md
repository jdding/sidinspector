...
Timestamp: 2026-05-22 13:38:34 CST
...
Post-review utility polish was applied without adding a new PDF table:

- Added `examples/minimal_adapter.py` and `docs/ADAPTER_TEMPLATE.md` for the
  item-to-code adapter onboarding path.
- Added `tools/profile_diagnostics_runtime.py` and
  `paper_assets/tables/table16_runtime_profile.*` for D1-D5 runtime notes.
- Updated §4 to define the category-prefix control and frame the capacity
  ablation as an intervention-style diagnostic case.
- Updated §5 to point to the minimal adapter template and runtime notes.
