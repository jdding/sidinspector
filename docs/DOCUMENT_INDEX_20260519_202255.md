...
- Paper-writing stance: the latest draft converts text-heavy Tables 1, 3, and
  4 into matrix/checklist-style tables while preserving the same claim boundary.
...
| CIKM paper draft | `paper/main.tex` | ACM draft; `paper/main.pdf` currently compiles to 5 pages total, with body through page 4; Tables 1, 3, and 4 are matrix/checklist-style |
