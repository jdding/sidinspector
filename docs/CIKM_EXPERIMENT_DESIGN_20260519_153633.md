...
| Table 2 | yes | GRID Musical feature-text vs bounded ReSID Musical diagnostic profile | `paper_assets/tables/table2_musical_diagnostic.*` |
| Table 3 | yes | Reviewer-facing artifact package checklist | `paper/sections/4_availability_limits.tex` |
...
tables live in the GitHub artifact.
