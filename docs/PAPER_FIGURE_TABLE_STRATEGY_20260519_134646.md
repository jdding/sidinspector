...
Implementation status as of 2026-05-19 13:44:35 CST: Fig. 1 is generated from
`tools/paper_figures/generate_audit_sid_pipeline.py`, Table 1 is facet-aware,
Table 2 is the same-item Musical diagnostic table, and Table 3 summarizes the
reviewer-facing artifact package. `latexmk` compiles `paper/main.pdf` to 5
pages total, with the body filling through page 4 and references/GenAI
