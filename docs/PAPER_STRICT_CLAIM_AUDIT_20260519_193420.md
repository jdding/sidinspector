...
after the method-inspired controller writing pass.
...
| Section 3 | GRID collided pairs have 3.86x co-occurrence lift | `paper_assets/tables/table8_qualified_collision_probe.csv`: `3.8631578947368426` | rounded ok |
| Section 3 | collision-heavy hash control has 1.19x co-occurrence lift | same CSV: `1.1851851851851851` | rounded ok |
| Section 3 | width-24 head-reserved controller has tail unique ratio 0.028 | `paper_assets/tables/table9_capacity_budget_sweep.csv`: `0.0281902844198338` | rounded ok |
...
Fig. 1 is a generated vector PDF. Table 1 is a facet/status/boundary matrix,
Table 2 is the same-item Musical artifact-profile table with D5a prefix counts,
and Table 3 is a reviewer action checklist tied to clean-checkout verification.
