...
- Paper-writing stance: the latest draft integrates method-inspired controller
  findings as stressor evidence, not named-method coverage.
...
| CIKM paper draft | `paper/main.tex` | ACM draft; `paper/main.pdf` currently compiles to 5 pages total, with body through page 4 and controller findings in Section 3 |
