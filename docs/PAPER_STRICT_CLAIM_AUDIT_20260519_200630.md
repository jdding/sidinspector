...
after the controlled-stressor table and prose-polish pass.
...
Table 3 is the controlled-stressor table, and Table 4 is a reviewer action
checklist tied to clean-checkout verification.
