...
| CIKM paper draft | `paper/main.tex` | ACM draft; `paper/main.pdf` currently compiles to 5 pages total, with body through page 4; GenAI precedes References and no forced reference page break remains |
